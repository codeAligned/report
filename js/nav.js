...
$(document).ready(function ($) {
  ...
  $('#fxd .logo').hide();
    ...
    /*
        ...
        this will listen to any scroll on the one page website
    */
...
//  var docY = $(document).height();
  ...
  // var insight8Y = insight7Y + $('#insight8').height();
    /*
        To add other sections, just use the following formula:
        var insight(++) = insight+ + $('#insight++').height()+100;
    */
...
/*
Scroll to anchors
These are the arious sections that are holding the various page directories
*/
$('a[href*="#"]')
  .not('[href="#"]')
  .not('[href="#0"]')
